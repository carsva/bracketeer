      ...
      <AppConsumer>
        {context => (
          <div className="LB2">
            ...
            team1={context.state.placing(4).name1 ? context.state.placing(4).name1 : ""} 
            logo1={context.state.placing(4).logo1 ? context.state.placing(4).logo1 : ""} 
            round="Round 2"/>
            ...
            team1={context.state.placing(5).name1 ? context.state.placing(5).name1 : ""} 
            logo1={context.state.placing(5).logo1 ? context.state.placing(5).logo1 : ""}
            />
            <Game
            ...
            team1={context.state.placing(6).name1 ? context.state.placing(6).name1 : ""} 
            logo1={context.state.placing(6).logo1 ? context.state.placing(6).logo1 : ""}
            />
            <Game
            ...
            team1={context.state.placing(7).name1 ? context.state.placing(7).name1 : ""} 
            logo1={context.state.placing(7).logo1 ? context.state.placing(7).logo1 : ""}
            />
          </div>
        )}
      </AppConsumer>
